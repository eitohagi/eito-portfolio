...
export async function generateMetadata({
  ...
  return {
    title: work.title,
    description: `${work.description} A work by Eito Hagi, Creative Technologist.`,
    authors: [
      {
        name: "Eito Hagi",
      },
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="grid gap-16 px-10 py-32 md:grid-cols-[1fr_2fr]">
        ...
        <div className="space-y-10 text-sm">
          <div>
            <p className="mb-2 text-gray-600">YEAR</p>
            <p>{work.year}</p>
          </div>

          <div>
            <p className="mb-2 text-gray-600">TOOLS</p>
            <p>{work.tools}</p>
          </div>

          <div>
            <p className="mb-2 text-gray-600">CREATOR</p>
            <p>Eito Hagi / 萩 栄斗</p>
          </div>
        </div>
